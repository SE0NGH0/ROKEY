...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': '-5.17', 'y_pose': '-1.81', 'z_pose': '0.01','model': 'waffle'},
        {'name': 'tb2', 'x_pose': '1.50', 'y_pose': '14.7321', 'z_pose': '0.01','model': 'waffle'},
        {'name': 'tb3', 'x_pose': '6.97', 'y_pose': '-9.09', 'z_pose': '0.01','model': 'burger'},
    ...
    # RViz config files for each robot
    rviz_config_files = {
        'tb1': os.path.join(package_dir, 'rviz', 'tb1.rviz'),
        'tb2': os.path.join(package_dir, 'rviz', 'tb2.rviz'),
        'tb3': os.path.join(package_dir, 'rviz', 'tb3.rviz'),
    }
    ...
    for robot in robots:
        ...
        map_file = os.path.join(
            package_dir, 'worlds', f"{robot['name']}_map.yaml"
        )
    ...
    for robot in robots:
        ...
        message = '{header: {frame_id: map}, pose: {pose: {position: {x: -11.2828, y: 17.8876, z: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.903256, w: 0.429102}}, }}'
        ...
        rviz_config_file = rviz_config_files[robot['name']]     
